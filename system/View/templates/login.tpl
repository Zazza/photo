...
<div><img alt="logo" src="{{ registry.uri }}img/ostora_logo.png" style="width: 400px; margin-bottom: 20px" /></div>
...
<form action="{{ registry.uri }}login/" method="post">
<div class="p">
...
<div class="p" style="text-align: right; margin-top: 10px"><a href='{{ registry.uri }}fm/'>Anonymous</a></div>
</form>
</div>
